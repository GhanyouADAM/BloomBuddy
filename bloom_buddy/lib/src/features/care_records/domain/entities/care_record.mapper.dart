...
class CareRecordMapper extends ClassMapperBase<CareRecord> {
  ...
  static const Field<CareRecord, String> _f$recordId = Field(
    'recordId',
    _$recordId,
    key: r'record_id',
  );
  ...
  static const Field<CareRecord, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
  );
...
mixin CareRecordMappable {
  String toJson() {
    return CareRecordMapper.ensureInitialized().encodeJson<CareRecord>(
      this as CareRecord,
    );
  }

  Map<String, dynamic> toMap() {
    return CareRecordMapper.ensureInitialized().encodeMap<CareRecord>(
      this as CareRecord,
    );
  }
  ...
  @override
  String toString() {
    return CareRecordMapper.ensureInitialized().stringifyValue(
      this as CareRecord,
    );
  }
  ...
  bool operator ==(Object other) {
    return CareRecordMapper.ensureInitialized().equalsValue(
      this as CareRecord,
      other,
    );
  }
...
class _CareRecordCopyWithImpl<$R, $Out>
  ...
  CareRecord $make(CopyWithData data) => CareRecord(
    ...
    careRequirementId: data.get(
      #careRequirementId,
      or: $value.careRequirementId,
    ),
